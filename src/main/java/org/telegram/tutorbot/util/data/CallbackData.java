...
public class CallbackData {
    ...
    public static final String TIMETABLE_ADD_MINUTE = "timetable_add_min_";
    public static final String USER = "usr";
    public static final String TIMETABLE_ADD_USER = "timetable_add_usr_";
    ...
    public static final String TASK_CREATE_USER = "task_create_usr_";
    ...
    public static final String TASK_CREATE_CHANGE_USER = "task_create_change_usr_";
